        ...
        for i in range(number_of_loops):
            ...
            if data[count:count + bytes_in_one_reading].find(0x42) != -1 \
                ...
                if check_value(data[count:count + bytes_in_one_reading]):
                    ...
                    pm_1_value_atmospheric = get_pm_10_value_atmospheric(data[count:count + bytes_in_one_reading])
                    pm_2_5_value_atmospheric = get_pm_2_5_value_atmospheric(data[count:count + bytes_in_one_reading])
                    pm_10_value_atmospheric = get_pm_10_value_atmospheric(data[count:count + bytes_in_one_reading])
                    print('atmospheric')
                    print(pm_1_value_atmospheric)
                    print(pm_2_5_value_atmospheric)
                    print(pm_10_value_atmospheric)
                    ws.append([now, pm_1_value_standard, pm_2_5_value_standard, pm_10_value_standard,
                               pm_1_value_atmospheric, pm_2_5_value_atmospheric, pm_10_value_atmospheric])
...
def get_pm_10_value_atmospheric(data):
